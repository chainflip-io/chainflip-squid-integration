 ...
 */
abstract contract GovernanceCommunityGuarded is IGovernanceCommunityGuarded {
     ...
     */
    function disableCommunityGuard()
        external
        override
        onlyCommunityKey
    ...
    modifier onlyCommunityKey() {
        require(
            msg.sender == _getCommunityKey(),
            "Governance: not Community Key"
        );
        _;
    }
    ...
    modifier onlyCommunityGuardEnabled() {
        require(
            !_communityGuardDisabled,
            "Governance: community guard disabled"
        );
        _;
    }
